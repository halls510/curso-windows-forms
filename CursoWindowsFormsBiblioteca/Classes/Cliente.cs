...
namespace CursoWindowsFormsBiblioteca.Classes
{
    public class Cliente
    {
        public class Unit
        {
            ...
            {
                if (this.NomePai == this.NomeMae) throw new Exception("Nome do Pai e da Mãe não podem ser iguais.");
                if (this.NaoTemPai == false) if (this.NomePai == "") throw new Exception("Nome do Pai não pode estar vazio quando a propriedade Pai Desconhecido não estiver marcado.");
        ...
        {
            return System.Text.Json.JsonSerializer.Deserialize<Unit>(vJson);
        }

        public static string SerializedClassUnit(Unit unit)
        {
            return System.Text.Json.JsonSerializer.Serialize(unit);
        }
    }
}
